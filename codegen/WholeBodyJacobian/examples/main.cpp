...
// Return Type  : void
//
void main_WholeBodyJacobian()
{
  double A[72];
  double dv[15];
  // Initialize function 'WholeBodyJacobian' input arguments.
  // Initialize function input argument 'in1'.
  // Call the entry-point 'WholeBodyJacobian'.
  argInit_1x15_real_T(dv);
  WholeBodyJacobian(dv, A);
}
